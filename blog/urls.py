...
from .views import (
    ...
    edit_profile,post_form,delete_post,post_details,like_post,home_page,all_posts,user_dashboard,create_or_update_category,get_category,delete_category,contact,user_posts
)
